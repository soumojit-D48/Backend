...
const getUserChannelProfile = asyncHandler(async(req, res) => {
    ...
    // This contains values defined in the URL route pattern.
    ...
    const channel = await User.aggregate([
        ...
        },
        {
            $addFields:{
                subscribersCount: {
                    $size: "$subscribers" // $subscribers is a field thats why $ sign
                },
...
const getWatchHistory = asyncHandler(async(req, res) => {
    // req.user._id -> string, not id we have to convert it into object id
